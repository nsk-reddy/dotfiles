...
echo "================================================="
echo "Install NvChad (Neovim config)"
echo "================================================="
git clone https://github.com/NvChad/starter ~/.config/nvim
rm -rf ~/.config/nvim/.git
echo "NvChad installed! Start Neovim with 'nvim'; plugins bootstrap on first launch."
...
ln -s -f $DOTFILES/nvim/plugins/nvim-tree.lua $HOME/.config/nvim/lua/plugins/nvim-tree.lua
